...
<body>
    ...
    <caption><b><h1>Details Of Customers</h1></b></caption>
    <table >
          <tr>
    ...
    $query = mysqli_query($conn,"select * from user where type = 'customer'");
...
function editUser(value) {
  var username = value;
  document.location.href = 'admin_editcustomer.php?username=' + username; 
}

function deleteFunction(value) {
    var username = value;
    if (confirm("Do you want to delete?")) {
        document.location.href = 'admin_deletecustomer.php?username=' + username; 
    } else {
