...
<body>
    ...
    <caption><b><h1>Details Of Staffs</h1></b></caption>
    <table >
          <tr>
    ...
    $query = mysqli_query($conn,"select * from user where type = 'staff'");
	...
	<script>
        ...
        function editUser(value) {
          var username = value;
          document.location.href = 'admin_editstaff.php?username=' + username; 
        }

        function deleteFunction(value) {
            var username = value;
            if (confirm("Do you want to delete?")) {
                document.location.href = 'admin_deletestaff.php?username=' + username; 
            } else {
