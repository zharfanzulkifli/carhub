...
<body>
    ...
    <caption><b><h1>Details Of Managers</h1></b></caption>
    <table >
          <tr>
    ...
    $query = mysqli_query($conn,"select * from user where type = 'manager'");
    ...
    <tr align=center>
      ...
      <td><button value="<?php echo $record['username'];?>" onclick="editUser(this.value)" class="btn btn-info">Edit</button></td>
      <td><button value="<?php echo $record['username'];?>" onclick="deleteFunction(this.value)" class="btn btn-danger">Delete</button></td>
    ...
    <h1><button value="mnanageradd" class="btn btn-default">ADD MANAGER</h1>
...
function editUser(value) {
  var username = value;
  document.location.href = 'admin_editmanager.php?username=' + username; 
}

function deleteFunction(value) {
    var username = value;
    if (confirm("Do you want to delete?")) {
        document.location.href = 'admin_deletemanager.php?username=' + username; 
    } else {
